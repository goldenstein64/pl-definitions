...
---@alias PLTokenStream fun(): (string, string)

---@alias PLLexerFilter { [function]: true, space?: boolean, comments?: boolean }

---@alias PLLexerOptions {[string]: any}
...
---@param filter? PLLexerFilter -- a table of token types to exclude, by default `{ space = true }`
...
---@return PLTokenStream -- a token stream
---@nodiscard
function lexer.scan(s, matches, filter, options) end

---insert tokens into a stream.
---@param tok PLTokenStream -- a token stream
...
---@overload fun(tok: PLTokenStream, a1: fun(): PLTokenStream)
---@overload fun(tok: PLTokenStream, a1: {[1]: string, [2]: string}[])
...
---@param filter? PLLexerFilter -- a table of token types to exclude, by default `{ space = true, comments = true }` (optional)
---@param options? PLLexerOptions -- a table of options; by default, `{ number = true, string = true }`, which means convert numbers and strip string quotes. (optional)
---@return PLTokenStream
---@nodiscard
...
---@param tok PLTokenStream -- the token stream
