...
---@alias PLSipOptions { at_start: boolean? }

---convert a SIP pattern into the equivalent Lua string pattern.
---@param spec string -- a SIP pattern
---@param options PLSipOptions -- a table; only the `at_start` field is currently meaningful and ensures that the pattern is anchored at the start of the string.
...
---@param options PLSipOptions -- option table
---@return boolean
